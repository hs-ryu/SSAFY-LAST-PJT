...
class ReviewListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Review
        fields = ('id', 'title', 'rank','created_at', 'updated_at','user',)

class ReviewSerializer(serializers.ModelSerializer):
    class Meta:
        model = Review
        fields = ('id', 'content','title', 'rank','created_at', 'updated_at','user',)
...
class VoteListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Vote
        fields = ('title', 'movie', 'option_one_count', 'option_two_count','user',)

class VoteSerializer(serializers.ModelSerializer):
    class Meta:
        model = Vote
        fields = ('title', 'option_one_count', 'option_two_count','user', )

class VoteCommentSerializer(serializers.ModelSerializer):
    class Meta:
        model = VoteComment
        fields = ('choice', 'content', 'user')