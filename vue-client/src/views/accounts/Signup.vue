<template>
  <div class="mx-auto" style="width: 300px;">
    <h1 class="fw-bold title-font my-5">회원가입</h1>
    <div class="my-3">
      ...
      <div class="my-4">
        <span class="mx-1">이미 가입하셨나요?</span>
        <span class="mx-1 main-color-content fw-bold mini-button" @click="$router.push({ name: 'Login' })">로그인</span>
      </div>
    </div>
  </div>
</template>
