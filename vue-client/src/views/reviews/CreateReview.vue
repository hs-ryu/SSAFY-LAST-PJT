<template>
  <div>
    ...
    <div class="startRadio">
      ...
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="1" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 1개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="1.5" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 1.5개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="2" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 2개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="2.5" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 2.5개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="3" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 3개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="3.5" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 3.5개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="4" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 4개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="4.5" v-model="rank">
        <span class="startRadio__img"><span class="blind">별 4.5개</span></span>
      </label>
      <label class="startRadio__box">
        <input type="radio" name="star" id="" value="5" v-model="rank">
...
.startRadio {
  ...
  &:after {
    ...
    z-index: 10;
    height: 40px;
    // background: url('/assets/star_img2.png'),
